...
logo_path = pasta_atual / 'DELLYS_LOGO-removebg-preview.png'  # Substitua pelo caminho do seu arquivo de imagem
logo = Image.open(logo_path)
st.sidebar.image(logo, width=200)
caminho_arquivo = pasta_atual / '1.1 CHECK LIST - Declarações Estaduais Dellys 2024.xlsx'
